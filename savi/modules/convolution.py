...
class CNN(nn.Module):
	...
	def __init__(self,
		...
		for i in range(num_layers):
			...
			# let bias be initialized to zeros like in flax.
			torch.nn.init.zeros_(module.bias)
			self.cnn_layers.add_module(module_name, module)
		...
		if self.output_size:
			...
			nn.init.zeros_(self.project_to_output.bias)
